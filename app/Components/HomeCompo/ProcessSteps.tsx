...
export default function ProcessSteps() {
  ...
  return (
    <section id="process-steps" className="bg-black text-white px-4 py-16">
      {/* Heading */}
      <div className="text-center max-w-3xl mx-auto mb-12">
        <h2 className="text-2xl md:text-4xl lg:text-[52px] font-bold">
          How We Turn Ideas into Impact
        </h2>
        <p className="text-[#808080] text-[22px] mt-4">
      ...
      {/* Steps */}
      <div className="max-w-6xl mx-auto border border-[#222222] rounded-2xl overflow-hidden">
        {PROCESS_STEPS.map((step, i) => {
          ...
          return (
            <div
              key={i}
              className="flex flex-col md:flex-row items-stretch border-b border-[#222222] last:border-b-0 cursor-pointer transition-all duration-300 md:space-y-6" //can be add space-y-4
            ...
            >
              ...
              <div className="flex-1 p-6 md:p-8 flex flex-col justify-center bg-black">
                <div className="flex flex-col space-y-6">
                  {/* Phase + Number pill */}
                  <div className="inline-flex items-center border border-[#57BFFF] rounded-xl px-3 text-sm w-fit hover:bg-[#57BFFF]/10 transition-colors py-2">
                    ...
                    <div className="space-y-6">
                      ...
                      {step.cta && (
                        <button
                          ...
                          className={`bg-[#57BFFF] hover:bg-[#42aee6] text-white px-5 py-2 rounded-lg font-semibold w-fit transition-all duration-300 ${
                            isActive
